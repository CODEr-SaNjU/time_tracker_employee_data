...
urlpatterns = [
    ...
    path('Admin_panel_Activity/',views.Admin_panel_Activity,name='Admin_panel_Activity'),
    path('Admin_panel_deprtmnt/',views.Admin_panel_deprtmnt,name='Admin_panel_deprtmnt'),
    path('Admin_panel_enquiry_no/',views.Admin_panel_enquiry_no,name='Admin_panel_enquiry_no'),
    path('Admin_panel_loction/',views.Admin_panel_loction,name='Admin_panel_loction'),
    path('Admin_panel_name_of_project/',views.Admin_panel_name_of_project,name='Admin_panel_name_of_project'),
    path('Admin_panel_project_enq/',views.Admin_panel_project_enq,name='Admin_panel_project_enq'),
