...
urlpatterns = [
    ...
    path('Admin_panel/employee_data/employee_data/Add/',views.Admin_panel_employee_data_Add,name="Admin_panel_employee_data_Add"),
    path('Admin_panel/employee_data/employee_data/Update/<str:pk_id>/',views.Admin_panel_employee_data_Add,name="Admin_panel_employee_data_Add"),

    path('Admin_panel/employee_data/export_excel/',views.Admin_panel_export_excel_search,name='Admin_panel_export_excel'),
