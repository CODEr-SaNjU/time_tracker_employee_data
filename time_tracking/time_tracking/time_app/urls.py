...
urlpatterns = [
    ...
    path('Admin_panel/deprtmnt/Add/',views.Admin_panel_deprtmnt_Add,name='Admin_panel_deprtmnt_Add'),
    path('Admin_panel/loction/Add/',views.Admin_panel_loction_Add,name='Admin_panel_loction_Add'),
    path('Admin_panel/project_enq/Add/',views.Admin_panel_project_enq_Add,name='Admin_panel_project_enq_Add'),
